...
import com.example.rezepte.adapters.SaladAdapter
...
class SaladFragment : Fragment(), View.OnClickListener {
    ...
    private fun showRezepte() {
        ...
        recyclerView.adapter = SaladAdapter(rezepte, ::deleteRecipe)
    }
